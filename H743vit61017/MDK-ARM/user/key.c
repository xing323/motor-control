...
uint8_t Motor1_zeroed(void)
{
	...
	{
		Motor1_driver_ctrl(Key_PWM_val,1);
...
uint8_t Motor2_zeroed(void)
{
	...
	if(((HAL_GPIO_ReadPin(KEY_Up_GPIO_Port,KEY_Up_Pin))==GPIO_PIN_SET)&&(key_up==1))           //正转
	{
		Motor2_driver_ctrl(Key_PWM_val,1);
	  HAL_GPIO_WritePin( LED1_GPIO_Port, LED1_Pin,GPIO_PIN_RESET);
		key_move_flag=1;
	}
	else if(((HAL_GPIO_ReadPin(KEY_Down_GPIO_Port,KEY_Down_Pin))==GPIO_PIN_SET)&&(key_down==1)) //反转
...
uint8_t Motor3_zeroed(void)
{
	...
	if(((HAL_GPIO_ReadPin(KEY_Up_GPIO_Port,KEY_Up_Pin))==GPIO_PIN_SET)&&(key_up==1))           //正转
	{
		Motor3_driver_ctrl(Key_PWM_val,1);
		HAL_GPIO_WritePin( LED1_GPIO_Port, LED1_Pin,GPIO_PIN_RESET);
		key_move_flag=1;
	}
	else if(((HAL_GPIO_ReadPin(KEY_Down_GPIO_Port,KEY_Down_Pin))==GPIO_PIN_SET)&&(key_down==1)) //反转
...
uint8_t Motor4_zeroed(void)
{
	...
	if(((HAL_GPIO_ReadPin(KEY_Up_GPIO_Port,KEY_Up_Pin))==GPIO_PIN_SET)&&(key_up==1))           //正转
	{
		Motor4_driver_ctrl(Key_PWM_val,1);
		HAL_GPIO_WritePin( LED1_GPIO_Port, LED1_Pin,GPIO_PIN_RESET);
		key_move_flag=1;
	}
	else if(((HAL_GPIO_ReadPin(KEY_Down_GPIO_Port,KEY_Down_Pin))==GPIO_PIN_SET)&&(key_down==1)) //反转
...
uint8_t Motor5_zeroed(void)
{
	...
	if(((HAL_GPIO_ReadPin(KEY_Up_GPIO_Port,KEY_Up_Pin))==GPIO_PIN_SET)&&(key_up==1))           //正转
	{
		Motor5_driver_ctrl(Key_PWM_val,1);
		HAL_GPIO_WritePin( LED1_GPIO_Port, LED1_Pin,GPIO_PIN_RESET);
		key_move_flag=1;
	}
	else if(((HAL_GPIO_ReadPin(KEY_Down_GPIO_Port,KEY_Down_Pin))==GPIO_PIN_SET)&&(key_down==1)) //反转
...
uint8_t Motor6_zeroed(void)
{
	...
	if(((HAL_GPIO_ReadPin(KEY_Up_GPIO_Port,KEY_Up_Pin))==GPIO_PIN_SET)&&(key_up==1))           //正转
	{
		Motor6_driver_ctrl(Key_PWM_val,1);
		HAL_GPIO_WritePin( LED1_GPIO_Port, LED1_Pin,GPIO_PIN_RESET);
		key_move_flag=1;
	}
	else if(((HAL_GPIO_ReadPin(KEY_Down_GPIO_Port,KEY_Down_Pin))==GPIO_PIN_SET)&&(key_down==1)) //反转
...
//////手动演示程序，使用按键控制,必须在死循环里面使用
void Position_Demo(int PWM)
{
...
void Motor_Adusted_from_PC(void)
{
	...
	if(((HAL_GPIO_ReadPin(KEY_Up_GPIO_Port,KEY_Up_Pin))==GPIO_PIN_SET))           //正转
		{
			Motor1_driver_ctrl(PWM,(int)Motor1.Enable_Flag);
			Motor2_driver_ctrl(PWM,(int)Motor2.Enable_Flag);
			Motor3_driver_ctrl(PWM,(int)Motor3.Enable_Flag);
			Motor4_driver_ctrl(PWM,(int)Motor4.Enable_Flag);
			Motor5_driver_ctrl(PWM,(int)Motor5.Enable_Flag);
			Motor6_driver_ctrl(PWM,(int)Motor6.Enable_Flag);
			HAL_GPIO_WritePin( LED1_GPIO_Port, LED1_Pin,GPIO_PIN_RESET);
		}
	else if(((HAL_GPIO_ReadPin(KEY_Down_GPIO_Port,KEY_Down_Pin))==GPIO_PIN_SET)) //反转
		{
