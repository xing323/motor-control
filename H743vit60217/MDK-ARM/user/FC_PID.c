...
void Control_FC_update(void)
{
	...
	if(folwd_cnt> 2999)
  {
    ...
    Motor1.U = (int16_t)Left_InvKine.angle_M1_dv[folwd_cnt]+ (int16_t)Motor_x_control_pid_PWM(&Motor1pid,Motor1.Target,Motor1.angle);
	  Motor2.U = (int16_t)Left_InvKine.angle_M2_dv[folwd_cnt]+ (int16_t)Motor_x_control_pid_PWM(&Motor2pid,Motor2.Target,Motor2.angle);
	  Motor3.U = (int16_t)-Left_InvKine.angle_M3_dv[folwd_cnt]+ (int16_t)Motor_x_control_pid_PWM(&Motor3pid,-Motor3.Target,Motor3.angle);
	  Motor4.U = (int16_t)Right_InvKine.angle_M1_dv[folwd_cnt]+ (int16_t)Motor_x_control_pid_PWM(&Motor4pid,Motor4.Target ,Motor4.angle);
	  Motor5.U = (int16_t)Right_InvKine.angle_M2_dv[folwd_cnt]+ (int16_t)Motor_x_control_pid_PWM(&Motor5pid,Motor5.Target,Motor5.angle);
	  Motor6.U = (int16_t)-Right_InvKine.angle_M3_dv[folwd_cnt]+ (int16_t)Motor_x_control_pid_PWM(&Motor6pid,-Motor6.Target,Motor6.angle);
